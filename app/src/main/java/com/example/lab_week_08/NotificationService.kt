...
//This function is called after the count down has completed
    private fun notifyCompletion(Id: String) {
        Handler(Looper.getMainLooper()).post {
            // Menggunakan _trackingCompletion yang didefinisikan di companion object
            _trackingCompletion.value = Id
        }
    }

    companion object {
        private val _trackingCompletion = MutableLiveData<String>()
        val trackingCompletion: LiveData<String> = _trackingCompletion
